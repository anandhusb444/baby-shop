              ...
              <tbody>
                {
                    userData.map((item)=> 
                        <tr key={item.id}>
                            ...
                            <td className='border-4 border-indigo-400 border-opacity-4 px-4 py-3'><button onClick={()=>handleRemove(item.id)} className='bg-slate-300 rounded-sm p-2 text-sm hover:scale-110 transition-transform duration-75 hover:rotate-6 hover:bg-gray-400 hover:text-white'>remove</button></td>
                        </tr>
                        )
