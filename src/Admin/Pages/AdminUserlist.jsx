            ...
            <table className='border-collapse border'>
              <thead>
                <tr>
                    ...
                    <th className='border-8 border-indigo-400 px-4 py-3'>Remove user</th>
                </tr>
              </thead>
              ...
              <tbody>
                {
                    userData.map((item)=> 
                        <tr key={item.id}>
                            ...
                            <td className='border-8 border-indigo-400 border-opacity-1 px-4 py-3'><button onClick={()=>handleViewCart(item.id)} className='bg-slate-300 rounded-sm p-2 text-sm hover:scale-110 transition-transform duration-75 hover:rotate-6 hover:bg-gray-400 hover:text-white'>view cart</button></td>
                            <td className='border-8 border-indigo-400 border-opacity-2 px-4 py-3'><button className='bg-slate-300 rounded-sm p-2 text-sm hover:scale-110 transition-transform duration-75 hover:rotate-6 hover:bg-gray-400 hover:text-white'>view order</button></td>
                            <td className='border-8 border-indigo-400 border-opacity-4 px-4 py-3'><button onClick={()=>handleRemove(item.id)} className='bg-slate-300 rounded-sm p-2 text-sm hover:scale-110 transition-transform duration-75 hover:rotate-6 hover:bg-gray-400 hover:text-white'>remove</button></td>
                        </tr>
                        )
